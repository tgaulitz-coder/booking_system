...
<!-- Två olika flikar. En för att skapa enskilda tider och en för att skapa flera
     tider automatiskt utifrån datum och tidsintervaller. -->
<div class="formTabs">
...
<div id="singleFormWrapper">
    ...
    <form id="appointmentForm">
        ...
        <br>
        <!-- min datum satt till idag hindrar att tider skapas på datum som passerat. -->
        <input
            type="date"
            id="date"
            min="<?= date('Y-m-d') ?>"
...
<div id="bulkFormWrapper" style="display: none;">
    ...
    <form id="bulkAppointmentForm">
        ...
        <br>
        <input type="date" id="bulkStartDate" min="<?= date('Y-m-d') ?>" required>

        <br><br>

        <label>Slutdatum</label>
        <br>
        <input type="date" id="bulkEndDate" min="<?= date('Y-m-d') ?>" required>
