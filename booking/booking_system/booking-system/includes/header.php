...
// Skapar projektets webbsökväg dynamiskt. Då fungerar menyn även om
...
<head>
    ...
    <!--  CSRF token skrivs ut här och läses av JavaScript inför varje AJAX arop som ändrar data -->
...
<body>
    ...
    <header>
        ...
        <!-- Menyn visas bara för inloggade användare  -->
        <?php if (isLoggedIn()): ?>
            ...
            <nav>
                ...
                <!-- Menyn visas bara för inloggade admin användare  -->
                <?php if (isAdmin()): ?>
